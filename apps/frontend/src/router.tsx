...
const RecordCreate = lazy(() => import('./pages/records/RecordCreate'));
const RecordDetails = lazy(() => import('./pages/records/RecordDetails'));
const RecordManage = lazy(() => import('./pages/records/RecordManage'));
...
const EmailCompose = lazy(() => import('./pages/notifications/EmailCompose'));
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<AppShell />}>
            ...
            <Route path="crm">
              ...
              />
              <Route
                path="contacts/:contactId/manage"
