...
| name | description |
|------|------|
| `decimal-digits` | *object type*: `int`<br>*default value*: `2`<br>*is required*: `FALSE`<br>On how many decimal digits the rounding should be done when displaying the value |
