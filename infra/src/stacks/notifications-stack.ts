...
export class NotificationsStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: NotificationsStackProps) {
    ...
    const emailHandler = new WebVellaLambdaService(this, 'EmailHandler', {
      ...
      codePath: '../services/notifications/publish',
      handler: 'WebVellaErp.Notifications::WebVellaErp.Notifications.Functions.EmailHandler::HandleAsync',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 30,
      description:
    ...
    const webhookHandler = new WebVellaLambdaService(this, 'WebhookHandler', {
      ...
      runtime: LambdaRuntime.DOTNET_9_AOT,
      codePath: '../services/notifications/publish',
      handler: 'WebVellaErp.Notifications::WebVellaErp.Notifications.Functions.QueueProcessor::HandleAsync',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 30,
      description:
    ...
    const queueProcessor = new WebVellaLambdaService(this, 'QueueProcessor', {
      ...
      runtime: LambdaRuntime.DOTNET_9_AOT,
      codePath: '../services/notifications/publish',
      handler: 'WebVellaErp.Notifications::WebVellaErp.Notifications.Functions.WebhookHandler::HandleHttpAsync',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 60,
      description:
