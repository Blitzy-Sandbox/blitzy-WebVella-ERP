...
export class EntityManagementStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: EntityManagementStackProps) {
    ...
    const commonEnvironment: { [key: string]: string } = {
      ...
      // Service-specific env vars matching code expectations (IConfiguration key mapping)
      'DynamoDB__MetadataTableName': metadataTable.tableName,
      'DynamoDB__RecordTableName': recordsTable.tableName,
    ...
    const entityHandler = new WebVellaLambdaService(this, 'EntityHandler', {
      ...
      codePath: '../services/entity-management/publish',
      handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.EntityHandler::FunctionHandler',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 60,
      description:
    ...
    const fieldHandler = new WebVellaLambdaService(this, 'FieldHandler', {
      ...
      runtime: LambdaRuntime.DOTNET_9_AOT,
      codePath: '../services/entity-management/publish',
      handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.FieldHandler::FunctionHandler',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 60,
      description:
    ...
    const relationHandler = new WebVellaLambdaService(this, 'RelationHandler', {
      ...
      runtime: LambdaRuntime.DOTNET_9_AOT,
      codePath: '../services/entity-management/publish',
      handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.RelationHandler::FunctionHandler',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 60,
      description:
    ...
    const recordHandler = new WebVellaLambdaService(this, 'RecordHandler', {
      ...
      runtime: LambdaRuntime.DOTNET_9_AOT,
      codePath: '../services/entity-management/publish',
      handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.RecordHandler::FunctionHandler',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 60,
      description:
    ...
    const dataSourceHandler = new WebVellaLambdaService(
      ...
      'DataSourceHandler',
      {
        ...
        runtime: LambdaRuntime.DOTNET_9_AOT,
        codePath: '../services/entity-management/publish',
        handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.DataSourceHandler::FunctionHandler',
        isLocalStack,
        memorySize: 512,
        timeoutSeconds: 60,
        description:
    ...
    const searchHandler = new WebVellaLambdaService(this, 'SearchHandler', {
      ...
      runtime: LambdaRuntime.DOTNET_9_AOT,
      codePath: '../services/entity-management/publish',
      handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.SearchHandler::FunctionHandler',
      isLocalStack,
      memorySize: 512,
      timeoutSeconds: 60,
      description:
    ...
    const importExportHandler = new WebVellaLambdaService(
      ...
      'ImportExportHandler',
      {
        ...
        runtime: LambdaRuntime.DOTNET_9_AOT,
        codePath: '../services/entity-management/publish',
        handler: 'WebVellaErp.EntityManagement::WebVellaErp.EntityManagement.Functions.ImportExportHandler::FunctionHandler',
        isLocalStack,
        memorySize: 512,
        timeoutSeconds: 300,
        description:
