...
- **CDM schema/mapping mismatch** — mismatched or missing CDM entity/field mappings between the ERP metadata and the Common Data Model surface. Reconcile the mapping against the CDM definitions before re-running init.
